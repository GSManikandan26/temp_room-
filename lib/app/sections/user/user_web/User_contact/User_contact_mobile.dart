...
class UserContactMobile extends StatefulWidget {
  const UserContactMobile({super.key});

  @override
  State<UserContactMobile> createState() => _UserContactMobileState();
}

class _UserContactMobileState extends State<UserContactMobile> {
  bool onTap = false;
