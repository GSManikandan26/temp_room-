...
class SubVendorProfileScreenWeb extends StatefulWidget {
  const SubVendorProfileScreenWeb({Key? key});

  @override
  _SubVendorProfileScreenWebState createState() => _SubVendorProfileScreenWebState();
}

class _SubVendorProfileScreenWebState extends State<SubVendorProfileScreenWeb> {
