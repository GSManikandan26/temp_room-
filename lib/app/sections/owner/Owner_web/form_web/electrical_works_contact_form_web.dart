...
class ElectricalContactFormWeb extends StatefulWidget {
  const ElectricalContactFormWeb({Key? key}) : super(key: key);

  @override
  _ElectricalContactFormWebState createState() => _ElectricalContactFormWebState();
}

class _ElectricalContactFormWebState extends State<ElectricalContactFormWeb> {
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text(
            'Electrical service Contact Form',
