...
class PaymentNotificationPageWeb extends StatefulWidget {
  const PaymentNotificationPageWeb({Key? key});

  @override
  State<PaymentNotificationPageWeb> createState() => _PaymentNotificationPageWebState();
}

class _PaymentNotificationPageWebState extends State<PaymentNotificationPageWeb> {
